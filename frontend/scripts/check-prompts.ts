...
// Обновлён 31.07.2026: в блок запретов добавлено «твоё имя — не имя
// собеседника». Повод из замера моделей: gpt-5.4-nano шесть раз за разговор
// обратилась к менеджеру именем самой пациентки.
//
// Прежние эталоны, если понадобится сверка: 5600 / 756826c9… (до этой правки),
// 5245 / 43357e28… (до блока «отношение к деньгам»).
const TAMARA_BASELINE = {
  length: 5693,
  md5: "2d78b460c58f2c7770ef9b7d500f6c90",
};
