...
// Обновлён 30.07.2026: добавлен блок «ОТНОШЕНИЕ К ДЕНЬГАМ». Прежний эталон —
// 5245 символов, 43357e28335045750c0ed36233baf1b9 — остаётся верным для
// промпта без этого блока, и это проверено: слот необязательный, пустой
// в промпт не выводится, поэтому пациентов без финансов он не задел
const TAMARA_BASELINE = {
  length: 5600,
  md5: "756826c94b8674cfcb40b07a31c8391e",
};
