...
export async function POST(request: NextRequest) {
  try {
    ...
    // Замок отрасли: медицинский конвейер собрал бы офису продаж диагнозы.
    // Случаи немедицинских отраслей пишутся заранее в пресете. Стоит
    // раньше демо-замка, чтобы демо офиса продаж получало свой отказ,
