      ...
      <div className="mx-auto max-w-[760px]">
        ...
        <Section title="5. Как мы обрабатываем данные">
          ...
          <p>
            ...
            пересылается в закрытый рабочий чат мессенджера Telegram. Серверы
            Telegram находятся за пределами Российской Федерации, поэтому
            такая пересылка является трансграничной передачей персональных
            данных. Отправляя заявку, вы соглашаетесь и с ней.
          </p>
          <p>
