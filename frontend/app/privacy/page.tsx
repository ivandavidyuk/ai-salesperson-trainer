      ...
      <div className="mx-auto max-w-[760px]">
        ...
        <Section title="2. Какие данные мы получаем">
          ...
          <p>
            ...
            отправителя не сохраняется: на один час хранится только его
            необратимый хеш, чтобы ограничить число заявок с одного адреса.
          </p>
        </Section>
        ...
        <Section title="5. Как мы обрабатываем данные">
          ...
          <p>
            Чтобы сотрудники оператора сразу узнали о заявке, её содержимое
            через сервер оператора в Германии пересылается в закрытый рабочий
            чат мессенджера Telegram. Этот сервер и серверы Telegram находятся
            за пределами Российской Федерации, поэтому такая пересылка является
            трансграничной передачей персональных данных. На сервере в Германии
            заявка не хранится. Отправляя заявку, вы соглашаетесь и с этой
            передачей.
          </p>
          <p>
            Действия с данными: сбор, запись, хранение, использование для связи
            с вами, передача в рабочий чат, удаление.
          </p>
        </Section>
