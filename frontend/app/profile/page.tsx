            ...
            <p className="max-w-[520px] text-[12.5px] leading-normal text-ink-muted">
              {!filled
                ...
                : !changed
                  ...
                  : "После сохранения тренажёр пересоберёт всех пациентов под вашу специализацию. Это занимает от нескольких секунд до пары минут."}
            </p>
            <Button
              type="button"
              onClick={handleSave}
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-ink/50">
      <div className="w-[520px] rounded-[18px] bg-surface-card px-[34px] pb-7 pt-8 shadow-2xl">
        ...
        <p className="mt-[18px] text-[13px] leading-relaxed text-ink-muted">
          Оставьте вкладку открытой до конца. Если закрыть сейчас, пациенты,
          до которых мы не дошли, останутся с прежними историями — их придётся
          собрать заново.
        </p>
