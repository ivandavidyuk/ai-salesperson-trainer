...
// разговора сбивает; на входе, лендинге и политике — потому что показывать
// некому: гость без входа получал бы 401 на каждый опрос
const МОЛЧИМ = ["/login", "/session", "/start", "/privacy"];
