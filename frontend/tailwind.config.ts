    ...
    extend: {
      colors: {
        ...
        warn: {
          DEFAULT: "#9A6B08",
          surface: "#FBEFD6",
          border: "#EBD9AE", // рамка предупреждения, парная к danger.border
        },
      ...
      // Шкала кеглей поднята 03.09 до нормы читаемости. Замер угловым
      // размером буквы (ISO 9241: минимум 16 угловых минут, оптимум 20)
      // показал, что прежние размеры были ниже нормы на любом мониторе:
      // основной текст 13,5px давал 14,9 угловой минуты на 24" FHD
      // и 10,0 на ультрашироком. Именованные размеры переопределены здесь,
      // произвольные — по месту, той же шкалой (мелкие +1,5px, крупные +1).
      fontSize: {
        xs: ["13.5px", { lineHeight: "1.35" }],
        sm: ["15.5px", { lineHeight: "1.45" }],
        base: ["17.5px", { lineHeight: "1.5" }],
        lg: ["19.5px", { lineHeight: "1.45" }],
      },
      fontFamily: {
