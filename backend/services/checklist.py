...
Одной и той же репликой все пункты не доказываются. Прежде чем сослаться
на неё второй раз, перечитай: есть ли в ней именно это действие."""
...
_DRILL_RULES = {"prevention": _PREVENTION_RULE, "intercept": _INTERCEPT_RULE}
